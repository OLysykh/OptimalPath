...
//        iTicketsDao.createTickets(ticket);
        LOGGER.info(ticket.getAirlinesModel().getId()+" airlineMOdel");
        LOGGER.info(ticket.getCitiesModel().getId()+" cityModel");
        LOGGER.info(ticket.getClassTypesModel().getId()+" classtype");
        LOGGER.info(ticket.getClientsModel().getId()+" client");
        LOGGER.info(ticket.getCitiesModel().getName()+" destinatuoon city name");
        LOGGER.info(ticket.getSeatsNum()+" seat");
        LOGGER.info(ticket.getPrice()+" price");
