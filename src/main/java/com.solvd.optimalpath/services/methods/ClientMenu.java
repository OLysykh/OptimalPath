...
import com.solvd.optimalpath.services.pathCalculation.DijkstraAlgorithm;
...
import com.solvd.optimalpath.services.weather.WeatherData;
import com.solvd.optimalpath.services.weather.WeatherMethods;
    ...
    public static void start() {
        ...
        for (CitiesModel element : citiesNames) {
            if (!element.getName().equals("Kyiv")) {
                ...
                try {
                    Thread.sleep(10); //500 поставим для Васи, а так 100 быстрее крутит
            ...
            switch (line) {
                case "1" -> {
                    ...
                    if (!lineAnimal.matches("[1-6]")) {
                        ...
                        LOGGER.info("To your ticket price extra 50 UAH will be added as an animal transportation fee");
                ...
                case "2" -> {
                    LOGGER.info("Thank you for your choice, updated ticket price is:");
